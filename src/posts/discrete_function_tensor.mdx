...
<Output>Final training loss: 0.0252 Final test loss: 0.0424</Output>
...
> row vector _ matrix _ matrix _ ... _ matrix \* column vector
...
<Output>
	Dataset has N=1503 samples and d=5 features. Final training loss: 15.3521 Final test loss: 54.4698
</Output>
...
<Output>TTML test loss: 2.8970 Random forest test loss: 3.2568</Output>
...
<Output>
	X_one_million.shape=(1000000, 5) Time taken by TT: 430ms Time taken by Forest: 2328ms
</Output>
...
<Output>TTML test loss (noisy): 7.1980 Random forest test loss (noisy): 5.1036</Output>
