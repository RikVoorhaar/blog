...
This doesn't sound too surprising, but I wondered if it is actually true. Can I show that there is _a statistically significant bias in figure skating scoring?_
