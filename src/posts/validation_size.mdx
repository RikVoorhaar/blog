...
<Output>
	SVC with rbf kernel error: 97.38 ± 0.25% SVC with deg 3 polynomial kernel error: 96.90 ± 0.27%
</Output>
...
<Output>
	KNN with 3 neighbors error: 96.64 ± 0.28% KNN with 4 neighbors error: 96.43 ± 0.29% KNN with 5
	neighbors error: 96.64 ± 0.28% KNN with 6 neighbors error: 96.36 ± 0.29% KNN with 7 neighbors
	error: 96.29 ± 0.29% KNN with 8 neighbors error: 96.17 ± 0.30%
</Output>
